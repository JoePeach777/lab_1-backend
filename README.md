...
## 📸 Место для скриншотов работы

> **Инструкция:** Сделай скриншоты работы серверов (например, как открыт сайт в браузере или как бегут логи в терминале VS Code), сохрани их в папку с проектом и замени строки ниже на пути к картинкам.

- **Скриншот работы в браузере (Главная страница и JSON-ответы):**

`![Скриншот браузера](./screenshots/browser.png)`

*(Место для твоей первой картинки)*

- **Скриншот терминала (Логирование запросов и запуск сервера):**

`![Скриншот терминала](./screenshots/terminal.png)`

*(Место для твоей второй картинки)*
